...
reg price lnq rGDPcapita ibn.nespp4 i.year `ifconditional', robust
pause
...
reg price lnq rGDPcapita ibn.nespp4 i.month  i.year  `ifconditional',robust
...
reg price lnq rGDPcapita ibn.nespp4 i.month  i.year  i.dow `ifconditional', robust
outreg2 using ${linear_table1}, tex(frag) label adds(ll, e(ll), rmse, e(rmse)) addtext(Year effects, Yes, Month Effects, Yes,  Day of week effects, Yes, Vessel Effects, No, Model, OLS) drop(`months' `years')  ctitle("Real Price")


areg price lnq rGDPcapita ib5096.nespp4 ib7.month  i.year i.dow  `ifconditional', absorb(permit) robust
...
ivregress 2sls price rGDPcapita ibn.nespp4  i.year (lnq=lnq_lag1)  `ifconditional' , robust
...
ivregress 2sls price rGDPcapita ibn.nespp4 i.month  i.year (lnq=lnq_lag1)  `ifconditional',robust
