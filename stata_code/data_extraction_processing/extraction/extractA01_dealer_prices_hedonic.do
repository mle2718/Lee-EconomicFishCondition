...
clear;
 ...
 forvalues yr=$yearstart/$yearend{;
	...
	clear;
	odbc load,  exec("select link, sum(spplndlb) as landings, sum(sppvalue) as value, nespp4, year, month, day, dealnum, vserial, vtripid, vgearid, alevel, elevel, permit, area, effind, fzone from cfdbs.cfdets`yr'aa 
