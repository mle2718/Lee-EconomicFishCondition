...
cap program drop silver_hake_bsa
...
program silver_hake_bsa
	...
	cap label drop bsas
	gen `output'=0
	replace `output'=1 if inlist(`areaname',511, 512, 513, 514, 515, 521, 522, 524, 533, 534, 561, 551, 465, 464)
	replace `output'=2 if `areaname'>=562 & `areaname'<=640
	replace `output'=2 if inlist(`areaname',538, 539, 525, 526, 537, 541, 542, 543,552, 700, 701, 702, 799)
