...
1.  I need to winnow down the functional forms and start estimating more rigorous models.
...
I need to put in the tables of month and year fixed effects, but there's lower prices from June -December. 2000-2009 had somewhat lower prices. Same for 2012-2019.  This is benchmarked to 1994. 



\begin{table}
  \begin{center}
    \input{./tables/silver_hake2.tex}
        \caption{A Table of Regression coefficients - IHS transformed variables.  The omitted category is "medium".   \label{silverhake2}}
