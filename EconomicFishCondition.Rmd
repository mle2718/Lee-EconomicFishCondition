...
\newpage
  \begin{table}
    \begin{center}
        ...
        \end{tabular}  
          \caption{Coefficients for an OLS regression of   \label{priceconditionreg}}
